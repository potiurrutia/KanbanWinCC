      ...
      <aside className="flex w-64 shrink-0 flex-col border-r border-slate-200 bg-white">
        ...
        <div className="flex-1 overflow-y-auto px-3 pb-4">
          <div className="mb-2 flex items-center justify-between px-1.5 pt-2">
            <span className="text-[11px] font-semibold uppercase tracking-wider text-slate-400">Equipos</span>
            <button
          ...
          <nav className="space-y-0.5">
            {teams.length === 0 && (
              <p className="px-1.5 py-2 text-xs text-slate-400">Aún no perteneces a ningún equipo.</p>
            )}
            {teams.map((team) => {
          ...
          <button
            ...
            className="mt-4 flex w-full items-center gap-2 rounded-lg border border-dashed border-slate-300 px-2.5 py-2 text-sm text-slate-500 transition hover:border-indigo-300 hover:bg-indigo-50 hover:text-indigo-600"
          >
